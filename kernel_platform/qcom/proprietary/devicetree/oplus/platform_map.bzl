_platform_map = {
    ...
    "pineapple": {
        ...
        "dtbo_list": [
            ...
            {"name": "divo-23631-pineapple-overlay-EVT1.dtbo"},
            {"name": "divo-24672-pineapple-overlay.dtbo"},
            {"name": "divo-24602-pineapple-overlay.dtbo"},
    ...
    "volcano": {
        ...
        "dtbo_list": [
            {"name": "piaget-24607-volcano-overlay.dtbo"},
            {"name": "piaget-24623-volcano-overlay.dtbo"},
            {"name": "piaget-24698-volcano-overlay-Amazon.dtbo"},
            {"name": "piaget-24697-volcano-overlay.dtbo"},
            {"name": "piaget-24698-volcano-overlay-EU.dtbo"},
            {"name": "piaget-24698-volcano-overlay.dtbo"},
            {"name": "dongfeng-24718-volcano-overlay.dtbo"},
            {"name": "dongfeng-24744-volcano-overlay-EU.dtbo"},
            {"name": "dongfeng-24744-volcano-overlay.dtbo"},
            {"name": "dongfeng-24612-volcano-overlay.dtbo"},
            {"name": "dongfeng-24771-volcano-overlay-EU.dtbo"},
            {"name": "dongfeng-24772-volcano-overlay.dtbo"},
            {"name": "knightl-24065-volcano-overlay.dtbo"},
            {"name": "knightl-24291-volcano-overlay.dtbo"},
            {"name": "prado-25811-volcano-overlay.dtbo"},
            {"name": "prado-25861-volcano-overlay-IN-T0.dtbo"},
            {"name": "prado-25861-volcano-overlay-IN.dtbo"},
            {"name": "prado-25861-volcano-overlay-EU.dtbo"},
        ],
    },
    "pineapple-tuivm": {
        "dtb_list": [
